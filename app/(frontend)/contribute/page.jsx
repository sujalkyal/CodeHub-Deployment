  ...
  const toast = {
    success: (msg) =>
      setNotifications((prev) => [
        ...prev,
        { type: "success", msg, id: Date.now() },
      ]),
    error: (msg) =>
      setNotifications((prev) => [
        ...prev,
        { type: "error", msg, id: Date.now() },
      ]),
  };
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-slate-300 max-w-2xl mx-auto">
            Share your coding challenge with the community and help others learn
            and grow.
          </p>
        </div>
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <div className="bg-slate-900/50 rounded-lg p-4 border border-slate-600/50 backdrop-blur-sm">
            <code className="text-sm text-slate-300 font-mono">
              ...
              - twoSum
              <br />
              Input: vector_integer nums, integer target
              <br />
        ...
        <div>
          ...
          <div className="space-y-3">
            ...
            <div>
              <p className="text-sm text-slate-400 mb-2">
                2D vector - include dimensions:
              </p>
              <div className="bg-emerald-900/30 rounded-lg p-3 border border-emerald-500/30 backdrop-blur-sm">
                <code className="text-sm text-emerald-300 font-mono">
                  Input: integer rows, integer cols, vector_vector_integer
                  matrix
                </code>
              </div>
            </div>
        ...
        <div className="flex items-start gap-3 p-4 bg-blue-500/20 rounded-lg border border-blue-400/30 backdrop-blur-sm">
          ...
          <div>
            ...
            <p className="text-sm text-blue-200">
              Always test your structure format before submitting to ensure
